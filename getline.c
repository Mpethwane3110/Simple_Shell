...
/**
 * input_buf - fun to insert buffers in chaiined cmd
 * @info: param structure with args
 * @len: memory address of the length variable
 * @buf: pointer of the buf
 * Return: no. of bytes available
 */
...
/**
 * get_input - fu to get a (line-new line)
 * @info:param structure with args
